...
int cgiMain()
{
	...
	strcpy(sql, "create table stu(id int not null primary key, name varchar(20) not null, age int not null, ssex varchar(20) not null, dept varchar(20) not null)");
	...
	sprintf(sql, "insert into stu(id,name,age,ssex,dept) values(%d, '%s', %d, '%s','%s')", atoi(stuId), name, atoi(age), ssex, dept);
